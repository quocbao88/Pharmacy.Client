...
@Component({
  ...
  template: `
    ...
    <div id="print-section" *ngIf="receiptOrder">
      <div style="font-family: 'Times New Roman', Times, serif; color: #000; padding: 20px; background: #fff;">
        ...
        <div style="text-align: center; margin-bottom: 25px;">
          ...
          <p style="margin: 5px 0 0 0; font-size: 13px; font-style: italic;">Mã hóa đơn: {{ receiptOrder.orderCode }}</p>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px; font-size: 14px;">
          ...
          <tr *ngIf="receiptOrder.prescriptionCode">
            <td style="padding: 4px 0;">
              <strong>Mã đơn thuốc quốc gia:</strong> {{ receiptOrder.prescriptionCode }}
            </td>
            <td style="padding: 4px 0;">
              <strong>Bác sĩ kê đơn:</strong> {{ receiptOrder.prescribingDoctor || '—' }}
            </td>
          </tr>
          <tr *ngIf="receiptOrder.medicalFacility">
            <td colspan="2" style="padding: 4px 0;">
              <strong>Cơ sở y tế:</strong> {{ receiptOrder.medicalFacility }}
            </td>
          </tr>
          <tr *ngIf="receiptOrder.diagnostic">
            <td colspan="2" style="padding: 4px 0;">
              <strong>Chẩn đoán:</strong> {{ receiptOrder.diagnostic }}
            </td>
          </tr>
        </table>
        ...
        <table class="print-only-table" style="width: 100%; border-collapse: collapse; margin-top: 15px; margin-bottom: 15px;">
          ...
          <tbody>
            <tr *ngFor="let item of receiptOrder.details; let idx = index">
            ...
            <tr>
              ...
              <td colspan="2" style="border: 1px solid #000; padding: 8px; text-align: right; font-weight: bold;">
                {{ (receiptOrder.totalAmount || 0) + (receiptOrder.discountAmount || 0) | number:'1.0-0' }}đ
              </td>
            </tr>
            <tr *ngIf="receiptOrder.discountAmount > 0">
              ...
              <td colspan="2" style="border: 1px solid #000; padding: 8px; text-align: right; font-weight: bold; color: #ff0000;">
                -{{ receiptOrder.discountAmount | number:'1.0-0' }}đ
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2" style="border: 1px solid #000; padding: 8px; text-align: right; font-size: 15px; font-weight: bold; background-color: #f2f2f2;">
                {{ receiptOrder.totalAmount | number:'1.0-0' }}đ
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p style="margin: 10px 0; font-size: 14px; font-style: italic;">
          <strong>Tổng số tiền (viết bằng chữ):</strong> {{ getVietnameseWords(receiptOrder.totalAmount) }}
        </p>
        ...
        <div style="margin-top: 20px; font-size: 12px; line-height: 1.5; border-top: 1px solid #ddd; padding-top: 10px;">
          ...
          <ul style="margin: 5px 0 0 15px; padding: 0;">
            ...
            <li *ngIf="receiptOrder.notes">Ghi chú riêng: {{ receiptOrder.notes }}</li>
          </ul>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 40px; text-align: center; font-size: 14px;">
          ...
          <tr>
            <td></td>
            <td style="font-weight: bold;">{{ receiptOrder.staffName || 'Dược sĩ' }}</td>
          </tr>
        </table>
